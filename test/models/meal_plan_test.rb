...
describe MealPlan do
  ...
  describe "generating a weekly plan" do
    ...
    it "populates a meal for each day between teh start date and the end date" do
    ...
    describe "with more days than recipes" do
      let(:meal_plan) { build(:meal_plan, end_date: 8.days.from_now.to_date) }
      ...
      it "reuses recipes where necesssary" do
        meal_plan.build_meals
